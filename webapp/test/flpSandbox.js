		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employees",
									"targetURL": "#DCristinelsapfiori-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"DCristinelsapfiori-display": {
								"semanticObject": "DCristinelsapfiori",
								"action": "display",
								"description": "Aplicación para empleados",
								"title": "Employees",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=DCristinel.sapfiori",
									"url": sap.ui.require.toUrl("DCristinel/sapfiori")
								}
							}
						}
					}
